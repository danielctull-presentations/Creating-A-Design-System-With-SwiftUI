        ...
        ViewThatFits {
            ForEach(sizes, id: \.self) { size in
                configuration.color { token in
                    ...
                    switch token.classification {
                    case .comment: .system(size: CGFloat(size), weight: .light, design: .monospaced)
                    case .commentDoc: .system(size: CGFloat(size), weight: .light, design: .monospaced).italic()
                    case .commentDocKeyword: .system(size: CGFloat(size), weight: .light, design: .monospaced).italic()
                    case .mark: .system(size: CGFloat(size), weight: .semibold, design: .monospaced)
                    default: .system(size: CGFloat(size), weight: .regular, design: .monospaced)
                    }
                }
